			...
			<div class="row row-cols-1 row-cols-md-3">
				<div class="col mb-4">
					<div class="card">
						...
						<div class="card-body">
							<h5 class="card-title">Jumlah Konsumen Terdaftar</h5>
							<p class="card-text">
				...
				<div class="col mb-4">
					<div class="card">
						...
						<div class="card-body">
							<h5 class="card-title">Jumlah Vendor Terdaftar</h5>
							<p class="card-text">
								<h1 class=""><?= $countVendor->jml ?> <a href="" style="font-size: 20px;" class="text-info">Vendor</a></h1>
							</p>
						</div>
					</div>
				</div>
